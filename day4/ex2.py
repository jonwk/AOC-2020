...
# checks if all the required fields are present or not
def eval_fields(line):
    return all(valid_fields in line for valid_fields in ('byr', 'iyr','eyr', 'hgt','hcl', 'ecl','pid'))
...
for line in batch_file:
    if(eval_fields(line) and eval_passport(line)):
        valid_passsports+=1
